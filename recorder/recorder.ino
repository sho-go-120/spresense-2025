...
#define RECORD_FILE_NAME "test_mic.wav"
# define MIC_GAIN 210
SDClass theSD;
AudioClass *theAudio;
...
void setup()
{
  ...
  printf("Bytes per second: %d\n", recoding_byte_per_second);
  printf("Total recording size: %d bytes\n", recoding_size);
...
void loop() 
{
  ...
  int currentSize = theAudio->getRecordingSize();
  printf("Current recording size: %d / %d bytes\n", currentSize, recoding_size);
